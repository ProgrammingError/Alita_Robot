...
@Mirai.on_message(filters.command("shout", PREFIX_HANDLER))
...
@Mirai.on_message(filters.command("runs", PREFIX_HANDLER))
async def fun_run(_, m: Message):
    await m.reply_text(choice(fun_strings.RUN_STRINGS))
    return


@Mirai.on_message(filters.command("slap", PREFIX_HANDLER))
async def fun_slap(c: Mirai, m: Message):
    me = await c.get_me()
...
@Mirai.on_message(filters.command("roll", PREFIX_HANDLER))
...
@Mirai.on_message(filters.command("toss", PREFIX_HANDLER))
...
@Mirai.on_message(filters.command("shrug", PREFIX_HANDLER))
...
@Mirai.on_message(filters.command("bluetext", PREFIX_HANDLER))
...
@Mirai.on_message(filters.command("decide", PREFIX_HANDLER))
...
@Mirai.on_message(filters.command("react", PREFIX_HANDLER))
